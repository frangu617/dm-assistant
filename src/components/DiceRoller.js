...
const DiceRoller = () => {
    const [numberOfD4DiceToRoll, setNumberOfD4DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d4DiceRollResults, setD4DiceRollResults] = useState([]);
    const [numberOfD6DiceToRoll, setNumberOfD6DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d6DiceRollResults, setD6DiceRollResults] = useState([]);
    const [numberOfD8DiceToRoll, setNumberOfD8DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d8DiceRollResults, setD8DiceRollResults] = useState([]);
    const [numberOfD10DiceToRoll, setNumberOfD10DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d10DiceRollResults, setD10DiceRollResults] = useState([]);
    const [numberOfD12DiceToRoll, setNumberOfD12DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d12DiceRollResults, setD12DiceRollResults] = useState([]);
    const [numberOfD20DiceToRoll, setNumberOfD20DiceToRoll] = useState(1); // Default to rolling 1 die.
    const [d20DiceRollResults, setD20DiceRollResults] = useState([]);
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD4DiceToRoll(Number(e.target.value))}
                                    />
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD6DiceToRoll(Number(e.target.value))}
                                    />
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD8DiceToRoll(Number(e.target.value))}
                                    />
                            ...
                            <CardContent>
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD10DiceToRoll(Number(e.target.value))}
                                    />
                            ...
                            <CardContent>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD12DiceToRoll(Number(e.target.value))}
                                    />
                            ...
                            <CardContent>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min={1}
                                        onChange={(e) => setNumberOfD20DiceToRoll(Number(e.target.value))}
                                    />
